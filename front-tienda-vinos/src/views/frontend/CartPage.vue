      ...
      <div class="grid">
        ...
        <div class="col-12 lg:col-8">
          <div class="flex flex-column gap-4">
            ...
            <article
              v-for="item in cartStore.itemsList"
              :key="item.idProducto"
              class="flex align-items-center gap-4 p-4 border-round-lg surface-card border-1 surface-border"
            >
              <!-- Imagen -->
                ...
                <div class="flex align-items-center gap-4 mt-3">
                  ...
                  <div class="flex align-items-center border-1 surface-border border-round-md overflow-hidden">
                    ...
                    <Button
                      ...
                      text
                      size="small"
                      @click="cartStore.increment(item.idProducto)"
          ...
          <div class="border-round-lg p-5 sticky top-5" style="background:#2a0002; color:white;">
            ...
            <RouterLink to="/checkout">
              <Button
                ...
                class="w-full"
                style="background:#e4e4cc; border-color:#e4e4cc; color:#2a0002;
...
.cart-subtitle { color: rgba(0,0,0,.5); font-size: 1.1rem; font-style: italic; margin-top:.5rem; }

.item-name { font-family: 'Noto Serif', serif; font-size: 1.2rem; color: #2a0002; font-weight: 700; }
.item-price-unit { font-size: .875rem; color: #745853; text-transform: uppercase; letter-spacing: .1em; margin-top:.25rem; }
.item-subtotal { font-family: 'Noto Serif', serif; font-size: 1.2rem; color: #2a0002; font-weight: 700; }
...
.summary-row { opacity: .8; letter-spacing: .1em; text-transform: uppercase; }
.summary-label { font-size: .75rem; text-transform: uppercase; letter-spacing: .1em; opacity: .6; color: white; }
.summary-total { font-family: 'Noto Serif', serif; font-size: 2.5rem; font-weight: 700; font-style: italic; color: #e4e4cc; }
.summary-note { font-size: 10px; text-align: center; margin-top: 1.5rem; opacity: .4;
                text-transform: uppercase; letter-spacing: .1em; line-height: 1.8; color: white; }

.empty-title { font-family: 'Noto Serif', serif; font-size: 2rem; color: rgba(42,0,2,.5); font-style: italic; }
.empty-body  { color: rgba(0,0,0,.4); margin: 1rem 0 2rem; }
</style>